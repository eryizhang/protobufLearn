...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_house_2eproto[1];
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_house_2eproto = {
  false, false, 130, descriptor_table_protodef_house_2eproto, "house.proto", 
  &descriptor_table_house_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_house_2eproto::offsets,
  file_level_metadata_house_2eproto, file_level_enum_descriptors_house_2eproto, file_level_service_descriptors_house_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_house_2eproto_getter() {
  return &descriptor_table_house_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_house_2eproto(&descriptor_table_house_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata House::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_house_2eproto_getter, &descriptor_table_house_2eproto_once,
      file_level_metadata_house_2eproto[0]);
}
